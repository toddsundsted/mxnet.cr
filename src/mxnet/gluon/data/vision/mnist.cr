...
module MXNet
  module Gluon
    module Data
      module Vision
        class MNIST < MXNet::Gluon::Data::DownloadedDataset(MXNet::NDArray, Int32, Tuple(MXNet::NDArray, Int32))
          ...
          def initialize(root = File.join("~/", ".mxnet", "datasets", "mnist"), @train = true, transform = nil)
