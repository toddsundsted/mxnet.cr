module MXNet
  ...
  module Operations
    ...
    OP_INFO = {
      ...
      {"ElementWiseSum", "add_n", nil, nil, nil},
      {"Embedding", "Embedding", [:data,:weight], [:input_dim,:output_dim], [:dtype]},
      ...
      {"Pooling", "Pooling", [:data], nil, [:kernel,:pool_type,:global_pool,:cudnn_off,:pooling_convention,:stride,:pad]},
      ...
      {"UpSampling", "UpSampling", nil, [:scale,:sample_type,:num_args], [:num_filter,:multi_input_mode,:workspace]},
      ...
      {"_NDArray", "_NDArray", nil, [:info], nil},
      {"_Native", "_Native", nil, [:info], [:need_top_grad]},
      ...
      {"_contrib_MultiProposal", "_contrib_MultiProposal", [:cls_score,:bbox_pred,:im_info], nil, [:rpn_pre_nms_top_n,:rpn_post_nms_top_n,:threshold,:rpn_min_size,:scales,:ratios,:feature_stride,:output_score,:iou_loss]},
      ...
      {"_contrib_quantized_pooling", "_contrib_quantized_pooling", [:data,:min_data,:max_data], nil, [:kernel,:pool_type,:global_pool,:cudnn_off,:pooling_convention,:stride,:pad]},
      ...
      {"_sparse_adam_update", "adam_update", [:weight,:grad,:mean,:var], [:lr], [:beta1,:beta2,:epsilon,:wd,:rescale_grad,:clip_gradient]},
      {"_sparse_add_n", "add_n", nil, nil, nil},
      ...
      {"_sparse_dot", "dot", [:lhs,:rhs], nil, [:transpose_a,:transpose_b]},
      ...
      {"_sparse_sgd_mom_update", "sgd_mom_update", [:weight,:grad,:mom], [:lr], [:momentum,:wd,:rescale_grad,:clip_gradient]},
      {"_sparse_sgd_update", "sgd_update", [:weight,:grad], [:lr], [:wd,:rescale_grad,:clip_gradient]},
      ...
      {"adam_update", "adam_update", [:weight,:grad,:mean,:var], [:lr], [:beta1,:beta2,:epsilon,:wd,:rescale_grad,:clip_gradient]},
      {"add_n", "add_n", nil, nil, nil},
      ...
      {"ftml_update", "ftml_update", [:weight,:grad,:d,:v,:z], [:lr], [:beta1,:beta2,:epsilon,:wd,:rescale_grad,:clip_gradient]},
      ...
      {"log_softmax", "log_softmax", [:data], nil, [:axis]},
      ...
      {"mp_sgd_mom_update", "mp_sgd_mom_update", [:weight,:grad,:mom,:weight32], [:lr], [:momentum,:wd,:rescale_grad,:clip_gradient]},
      {"mp_sgd_update", "mp_sgd_update", [:weight,:grad,:weight32], [:lr], [:wd,:rescale_grad,:clip_gradient]},
      ...
      {"sgd_mom_update", "sgd_mom_update", [:weight,:grad,:mom], [:lr], [:momentum,:wd,:rescale_grad,:clip_gradient]},
      {"sgd_update", "sgd_update", [:weight,:grad], [:lr], [:wd,:rescale_grad,:clip_gradient]},
      ...
      {"squeeze", "squeeze", nil, nil, [:axis]},
      {"stack", "stack", nil, [:num_args], [:axis]},
